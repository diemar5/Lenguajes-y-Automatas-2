...
namespace Sintaxis_2
{
    public class Lexico : Token, IDisposable
    {
        ...
        public Lexico(string nombre)
        {
            ...
            {
                throw new Error("El archvio " + nombre + " no existe", log, linea, columna);
            }
        }
        ...
        private void Clasifica(int Estado)
        {
            switch (Estado)
            {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    setClasificacion(Tipos.Fin_de_Sentencia);
                    break;
                case 12:
                case 15:
        ...
        public void nextToken()
        {
            ...
            if (getClasificacion() == Tipos.Identificador)
            {
                switch (getContenido())
                {
                    case "char":
                    case "int":
                    case "float": setClasificacion(Tipos.Datos); break;
                    ...
                    case "do":
                    case "while":
                    case "for": setClasificacion(Tipos.Ciclos); break;
                }
            }
            if (!FinArchivo())
            {
